...
public class Shadow extends Character {
	...
	public Shadow(Path path, int speed, float pWidth, float pHeight,
			TiledTextureRegion pTextureRegion, LevelController levelController, int powerAttack, int defence) {
		super(path.getCoordinatesX()[0], path.getCoordinatesY()[0], pWidth, pHeight, pTextureRegion, levelController, powerAttack, defence);
